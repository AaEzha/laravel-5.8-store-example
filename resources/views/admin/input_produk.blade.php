...
<div class="content">
	<div class="container">
		...
		<h3 class="text-center mb-3">FORM INPUT PRODUK</h3><br>
			<div class="card p-3">
			<form action="{{ url('/simpan_input_produk') }}" method="POST" enctype="multipart/form-data">
					@csrf
				<div>
					...
					<label for="berat_produk">Berat Produkk</label>
					<input type="text" name="berat_produk" id="berat_produk" class="form-control"><br>

					<label for="tanggal_kadaluwarsa">Tanggal Kadaluwarsa</label>
					<input type="date" name="tanggal_kadaluwarsa" id="tanggal_kadaluwarsa" class="form-control"><br>
	...
	<!-- Modal -->
	<div class="modal fade" id="MyModalInput" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
