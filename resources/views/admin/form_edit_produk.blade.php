  ...
  <div class="content">
    <div class="container">
      <div class="p-3 mt-3">
        ...
        <div class="card p-3">
          <form action="{{ route('simpan_edit_produk') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="produk_id" value="{{ $daftar->produk_id }}">
            <div>
              ...
              <input type="date" name="tanggal_kadaluwarsa" id="tanggal_kadaluwarsa"
                value="{{ $daftar->tanggal_kadaluwarsa }}" class="form-control"><br>
